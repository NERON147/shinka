<template>
  <article>
    <section class="">
      <img src="/assets/img/manwheel.jpg" class="absolute top-0 left-0 w-full h-screen max-sm:min-h-[1000px] max-xxs:min-h-[1100px] object-cover -z-10" alt="Image description">
      <div class="container">
        <h1>
