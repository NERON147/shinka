<template>
  <article>
    <section class="">
      ...
      <div class="container">
        <h1>
          <div class="text-white max-sxxs:text-[25px] max-ss:text-[30px] max-ss:font-extrabold max-sm:text-[50px] max-md:text-[60px] text-[70px] font-bold mt-[220px] max-ss:mt-[180px] max-ss:leading-[50px] max-sm:leading-[60px] max-md:leading-[75px] leading-[90px]">
            ШИНОМОНТАЖ, СТО <br>
